...
<template>
    <AuthenticatedLayout>
        ...
        <template #header>
            ...
            <ul class="max-w-md space-y-1 text-gray-500 list-none list-inside " v-if="can.relawanView" >
                <li>
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg py-5 px-3">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-6 flex justify-center items-center w-full gap-4">
                                ...
                                <div class="w-1/2">
                                    <label for="nama"
                                        class="block mb-2 text-sm font-medium text-gray-900 ">RT/RW</label>
                            ...
                            <div class="mb-6">
                                <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 ">No.
                                    Telpon</label>
                            ...
                            <div class="mb-6">
                                <label for="nama"
                                    class="block mb-2 text-sm font-medium text-gray-900 ">Jumlah Anggota Yang
                                    Memilih</label>
                            ...
                            <div class="mb-5">
                                <h3 class="mb-4 font-semibold text-gray-900 ">1. Menurut Bapak/Ibu, Kira-kira
                                    apa
                                ...
                                <ul
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg">
                                        <div class="flex items-center pl-3">
                                            ...
                                            <label for="list-radio-license"
                                                class="w-full py-3 ml-2 text-sm font-medium text-gray-900">a.
                                                Pembangunan
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg">
                                        <div class="flex items-center pl-3">
                                            ...
                                            <label for="list-radio-id"
                                                class="w-full py-3 ml-2 text-sm font-medium text-gray-900">b.
                                                Penciptaan
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg">
                                        <div class="flex items-center pl-3">
                                            ...
                                            <label for="list-radio-millitary"
                                                class="w-full py-3 ml-2 text-sm font-medium text-gray-900">c.
                                                Bantuan
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg">
                                        <div class="flex items-center pl-3">
                                            ...
                                            <label for="list-radio-passport"
                                                class="w-full py-3 ml-2 text-sm font-medium text-gray-900">d.
                                                Bantuan
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg">
                                        <div class="flex items-center pl-3">
                                            <input id="list-radio-passport" type="radio" v-model="Form.pertanyaan1"
                                                ...
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2 ">
                                            <label for="list-radio-passport"
                                                class="w-full py-3 ml-2 text-sm font-medium text-gray-900">e.
                                                Pendidikan
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg">
                                        <div class="mb-6">
                                            <label for="nama"
                                                class="block mb-2 text-sm font-medium text-gray-900 ">Masalah
                                                Lainnya</label>
                            ...
                            <div class="mb-5">
                                <h3 class="mb-4 font-semibold text-gray-900 ">2. Apakah Bapak/Ibu Mendukung
